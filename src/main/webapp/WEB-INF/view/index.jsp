...
<html lang="en">
    			...
    			<div class="col-lg-12 pr-1 aside-stretch">
	        		...
	        		<div class="row">
	        			...
	        			<div class="col-md d-flex py-md-4">
	        				<div class="form-group align-self-stretch d-flex align-items-end">
			                    ...
			                    <select name="" id="" class="form-control">
			                    	<option value="">2BHK Home</option>
			                      <option value="">3BHK Home</option>
	        			...
	        			<div class="col-md d-flex">
			              ...
			              <a href="#" class="btn btn-black py-5 py-md-3 px-4 align-self-stretch d-block"><span>Check</span></a>
			            </div>
	        			</div>
	        		</div>
	        	</form>
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb ftco-services-wrap">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-3">
						<a href="/rooms" class="services-wrap img align-items-end d-flex" style="background-image: url(images/room-3.jpg);">
					...
					<div class="col-md-3">
						<a href="/guides" class="services-wrap img align-items-end d-flex" style="background-image: url(images/gide.jpg);">
							<div class="text text-center pb-2">
					...
					<div class="col-md-3">
						<a href="/restaurants" class="services-wrap img align-items-end d-flex" style="background-image: url(images/resto.jpg);">
							<div class="text text-center pb-2">
								<h3>Restaurants</h3>
							</div>
						</a>
					...
					<div class="col-md-3">
						<div class="services-wrap services-overlay img align-items-center d-flex" style="background-image: url(images/sleep.jpg);">
							<div class="text text-center pb-2">
								...
								<div class="icon">
									<a href="/villas"><span class="ion-ios-arrow-forward"></span></a>
								</div>
								</div>
							</div>
						</div>
  ...
  <section class="ftco-section">
      ...
      <div class="card">
        <img src="images/image_1.jpg" alt="Rooms">
        ...
        <div class="card__details">
          ...
          <p>Provides the services to stay peacefully in your own space</p>
  
          <center>
          <a href="/rooms">Read more</a>
          </center>
      ...
      <!-- A div with card class for the card  -->
      <div class="card">
        <img src="images/image_2.jpg" alt="villas's">
        ...
        <div class="card__details">
          ...
          <!-- A div with name class for the name of the card -->
          <div class="name">Villas's</div>
  
          <p>Provides the services to stay peacefully in your own villas's space</p>
  <center>
          <a href="/villas">Read more</a>
          </center>
        </div>
      ...
      <!-- A div with card class for the card  -->
      <div class="card">
        <img src="images/image_3.jpg" alt="Resturants">
        ...
        <div class="card__details">
          ...
          <!-- A div with name class for the name of the card -->
          <div class="name">Resturants</div>
  
          <p>Provides the services to give more information about resturants</p>
     <center>
