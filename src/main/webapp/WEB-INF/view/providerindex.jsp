...
<title>HEAVENSGATE&mdash; PROVIDER</title>
        ...
        <div class="main-sidebar sidebar-style-3">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <a href="/viewproviders">PROVIDER</a>  
                </div>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="menu-header"></li>
                     <li class="dropdown ">
                        <a href="/viewproviders" class=""><i ></i><span>View Providers</span></a>
            ...
            <section class="section">
                <div class="row">
                    ...
                    <div class="card card-statistic-2">
                        ...
                        <div class="card-stats-title">Customers - 
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="card card-statistic-2">
                            <div class="card-stats">
                            <div class="card-stats-title">Rooms - 
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="card card-statistic-2">
                            <div class="card-stats">
                            <div class="card-stats-title">Villa's - 
